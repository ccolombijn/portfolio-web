...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Contracts\ContactRepositoryInterface' => \App\Repositories\JsonContactRepository::class,
            'App\Contracts\PageRepositoryInterface' => \App\Repositories\JsonPageRepository::class,
            'App\Contracts\ProjectRepositoryInterface' => \App\Repositories\JsonProjectRepository::class,
            'Gemini\Contracts\ClientContract' => \Gemini\Client::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./shared/httpd/portfolio-web/public/storage' => 'string',
            ...
            'gemini.request_timeout' => 'integer',
...
'app.aliases.Vite','app.data_source','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.links./shared/httpd/portfolio-web/public/storage','fortify.guard','fortify.middleware','fortify.auth_middleware','fortify.passwords',
...
'fortify.redirects.password-reset','fortify.features','gemini.api_key','gemini.base_url','gemini.request_timeout',
...
'hashing.argon.threads','hashing.argon.time','hashing.argon.verify','hashing.rehash_on_login','cors.paths',
'cors.allowed_methods','cors.allowed_origins','cors.allowed_origins_patterns','cors.allowed_headers','cors.exposed_headers',
'cors.max_age','cors.supports_credentials','concurrency.default','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Jpegoptim','image-optimizer.optimizers.Spatie\\ImageOptimizer\\Optimizers\\Pngquant',
...
'image-optimizer.timeout','image-optimizer.log_optimizer_activity','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'login','logout','password.request','password.reset',
'password.email','password.update','register','user-profile-information.update',
...
'two-factor.secret-key','two-factor.recovery-codes','home',
'about','skills','portfolio.index','portfolio.project','contact.show',
'gemini.generate','contact.submit','contact.download','password.request','password.email',
'password.reset','password.update','password.confirm','admin.dashboard',
'admin.pages.index','admin.pages.create','admin.pages.store','admin.pages.edit','admin.pages.update',
'admin.pages.destroy','admin.projects.index','admin.projects.create','admin.projects.store','admin.projects.edit',
'admin.projects.update','admin.projects.destroy','admin.files.index','admin.files.upload','admin.files.upload.store',
'admin.files.destroy','admin.files.view','admin.settings.index','admin.settings.update','storage.local',);
        registerArgumentsSet('views', 
'admin.dashboard','admin.edit','admin.files.index','admin.files.upload','admin.files.view',
'admin.login','admin.overview','admin.pages.create','admin.pages.edit','admin.pages.index',
'admin.projects.create','admin.projects.edit','admin.projects.index','admin.register','admin.settings',
'auth.login','auth.passwords.confirm','auth.passwords.email','auth.passwords.reset','auth.register',
'auth.verify','components.button','components.form','components.forms.checkbox','components.forms.input',
'components.forms.select','components.image','components.sections.clickblocks','components.sections.content','components.sections.cta',
'components.sections.footer','components.sections.header','components.sections.introduction','components.sitemap','errors.4xx',
'errors.5xx','errors.404','errors.500','errors.503','layouts.admin',
'layouts.app','layouts.app.ui','layouts.content','layouts.footer','layouts.header',
'mail.contact','navigation.nav','pages.contact','pages.default','pages.detail',
'pages.overview','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
...
'DATA_SOURCE','DB_CONNECTION','SESSION_DRIVER','SESSION_LIFETIME','SESSION_ENCRYPT',
