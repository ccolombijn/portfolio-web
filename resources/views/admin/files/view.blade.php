...
@section('content')
    ...
    <p class="text-sm">{{$file['type']}} | {{$file['size']}} | Last modified {{$file['date']}}</p>
    <div class="bg-white p-4 boder border-stone-300 shadow mb-4" style="width:80vw;overflow:scroll;">
    ...
    <pre class="inline">Checksum:{{$file['hash']}}</pre>
